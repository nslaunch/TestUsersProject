...
public abstract class TestUsersProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static TestUsersProjectWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(TestUsersProjectWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<TestUsersProjectDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<TestUsersProjectDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<TestUsersProjectDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<TestUsersProjectDbContext, Task<T>> func)
    {
        T result;
