...
namespace TestUsersProject.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly TestUsersProjectDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = TestUsersProjectConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(TestUsersProjectDbContext context)
    {
        _context = context;
    }
